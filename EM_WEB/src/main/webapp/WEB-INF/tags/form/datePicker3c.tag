...
<%-- 
写法示例
<form:datePicker3c labelName="开通日期" name="OPEN_DATE"  rules="{dateFmt:'yyyy年MM月dd日 HH:mm:ss'}" defaultValue="${record.OPEN_DATE}" />
<form:datePicker3c labelName="开通日期" name="OPEN_DATE"  defaultValue="${record.OPEN_DATE}" />
rules 写法更多细节
...
<!-- {skin:'${skin }',dateFmt:'${dateFmt }',maxDate:'${maxDate }',minDate:'${minDate }'} -->
