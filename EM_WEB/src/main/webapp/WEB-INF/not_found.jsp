...
<link href="${ctx}/theme/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="${ctx}/theme/assets/admin/pages/media/pages/earth.jpg" class="img-responsive" alt="">
</div>
