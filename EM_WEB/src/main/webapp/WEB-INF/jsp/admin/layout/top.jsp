...
<!-- BEGIN HEADER -->
<div id="main_top" class="page-header navbar navbar-fixed-top" style='background: url(${ctx}/theme/assets/admin/${layout}/img/shouye_bac0.png) left repeat-x; background-color:white; height:60px; border-bottom:solid 4px #1caf9a;'>
    <!-- BEGIN HEADER INNER -->
    <div class="page-header-inner">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="index.html">
            <img src="${ctx}/theme/assets/admin/${layout}/img/logo3.png" alt="logo3" style='height:30px; margin-left:20px; margin-top:14px;' class="logo-default"/>
            </a>
        ...
        <!-- BEGIN TOP NAVIGATION MENU -->
            ...
            <ul class="nav navbar-nav pull-right">
            	<li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style='padding-left:0;padding-right:0; margin-right:10px; margin-top:5px;padding-bottom: 0px !important;    background: transparent;'>
                    <%-- <img alt="" class="img-circle" src="${ctx}/theme/assets/admin/${layout}/img/avatar3_small.jpg"/> --%>
                    <span class="username" style=' font-size:14px;font-weight:bold;'>
                    ${loginEmp.EMP_NAME }</span>
                    <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu" style='margin-top:10px; margin-right:10px;box-shadow:1px 1px 1px 1px #7d858e;' >
                        <li style='height:36px;color:white;'>
                            <a class="btn green" href="#" data-target="#ajax_lg" data-toggle="modal">
                            <i class="icon-user" style='color:white;'></i> 上传头像 </a>
                        </li>
                         <!--  <li class="divider" style='border:solid 1px #616a69;'><li>-->
                        <li style 	='height:36px;color:white;'>
                            <a class="btn green" href="acOperator/forUpdatePassword.do" data-target="#ajax_lg" data-toggle="modal">
                            <i class="icon-lock" style='color:white;'></i> 密码修改 </a>
                        </li>
