...
$(function(){
	...
	$("#ajax_lg_model").on("hidden.bs.modal", function() {
		//清空columns。如果用户编辑或者新增属性后，没有点击确认保存，则用户输入信息不会保留
		//用户编辑或新建属性后，提醒用户一定要点击确认保存
		$.ajax({
			type: "post",
			url:'${ctx}/modelDetail/clearColumns.do',
		});
		$(this).html(loadingDivForAjaxModal);
	});
...
<div class="page-container">
	...
	<div class="modal fade bs-modal-lg" id="ajax_lg" role="basic" aria-hidden="true">
		<div class="modal-dialog modal-lg">
	 	...
	 	<!-- 数据模型专用弹出框模板 -->
	<!-- 模板一：加长模板   id:ajax_lg -->
	<div class="modal fade bs-modal-lg" id="ajax_lg_model" role="basic" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-body">
					<img src="${ctx}/theme/assets/admin/layout/img/loading-spinner-grey.gif" alt="" class="loading"> <span> &nbsp;&nbsp;Loading... </span>
