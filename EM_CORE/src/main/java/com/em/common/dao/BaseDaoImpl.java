...
public class BaseDaoImpl implements IBaseDao {
	 ...
	 * 
	 * @see
	 * org.sdyy.publics.dao.IBaseDao#insert(java.lang.String,java.lang.Object)
	 */
	@Override
	...
	public List<Object> queryPage(String sqlId, PageView pageView, Object t) {
		// 2016年3月30日11:38:31 刘宇祥 检测SQLID是否存在
		/*
		 * Collection<String> ms=
		 * sqlSessionFactory.getConfiguration().getMappedStatementNames();
		 * for(String m:ms) { if(m.equals(sqlId)) { System.out.println(m); } }
		 */
